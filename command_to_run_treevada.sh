...
echo "**** Running eval.py ****"
python3 eval.py external Seed_Programs/$bench/parse_$bench Seed_Programs/$bench/tinyc-test Seed_Programs/$1-$seed-tv.log #json, lisp, while, xml, turtle
...
echo "**** Running search.py ****"
#echo "python3 search.py external Seed_Programs/$bench/parse_$bench Seed_Programs/$bench/$bench-train-$seed Seed_Programs/$bench-$seed-tv.log"
#python3 search.py external Seed_Programs/micro-benchmarks/json/parse_micro-benchmarks/json Seed_Programs/micro-benchmarks/json/micro-benchmarks/json-train-r1 Seed_Programs/micro-benchmarks/json-r1-tv.log

#echo "**** Running eval.py ****"
#echo "python3 eval.py external Seed_Programs/$bench/parse_$bench Seed_Programs/$bench/$bench-test Seed_Programs/$bench-$seed-tv.log"

exit


#python3 search.py external Seed_Programs/micro-benchmarks/while/parse_while Seed_Programs/micro-benchmarks/while/guides-r1/ Seed_Programs/micro-benchmarks/while/while.log
#python3 eval.py external Seed_Programs/micro-benchmarks/while/parse_while Seed_Programs/micro-benchmarks/while/guides-r1/ 
#Seed_Programs/micro-benchmarks/while/parse_while Seed_Programs/micro-benchmarks/while/guides-r1/ Seed_Programs/micro-benchmarks/while/while.log



#python3 eval.py external Seed_Programs/tinyc/parse_tinyc Seed_Programs/tinyc/tinyc-train-r1  Seed_Programs/tinyc/tinyc-train-r1/tinyc-train-r1.log
