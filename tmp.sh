...
## STANDARD TREEVADA
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "json"; done >  logs_treevada_true_llm_false/json.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "lisp"; done >  logs_treevada_true_llm_false/lisp.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "while"; done >  logs_treevada_true_llm_false/while.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "xml"; done >  logs_treevada_true_llm_false/xml.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "turtle"; done >  logs_treevada_true_llm_false/turtle.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "c-500"; done >  logs_treevada_true_llm_false/c-500.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "curl"; done >  logs_treevada_true_llm_false/curl.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "tinyc"; done >  logs_treevada_true_llm_false/tinyc.log
#for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "minic"; done >  logs_treevada_true_llm_false/minic.log

for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "mysql"; done > logs_treevada_true_llm_false/shanto_log_mysql.log
for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "c"; done > logs_treevada_true_llm_false/shanto_log_c.log
for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "tiny"; done > logs_treevada_true_llm_false/shanto_log_tiny.log
for i in {1..5}; do timeout 12h bash command_to_run_treevada.sh "lua"; done > logs_treevada_true_llm_false/shanto_log_lua.log
