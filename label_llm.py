...
while i < len(system_prompt):
    ...
    i += 2
messages.append({'role': 'system', 'content': 'The output must be a single label, never any explanation. Use underscore if needed, never hyphen or any special character.'})
